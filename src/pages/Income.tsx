                ...
                incomes.map((income) => (
                  <div key={income.id} className="group flex items-center justify-between p-6 rounded-[2rem] hover:bg-white/[0.03] transition-all border border-transparent hover:border-white/5">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <div className="font-black text-white group-hover:text-green-500 transition-colors">{income.description || income.sourceName}</div>
                        <div className="text-[10px] font-black uppercase tracking-widest text-white/20">{income.sourceName} • {new Date(income.date).toLocaleDateString()}</div>
                      </div>
                    </div>
